...
// Value and referenc types parameters
/*
int a = 3;
int b = 4;
int c = 0;
...
RSVP("Tony", allergies: "Jackfruit", inviteOnly: true); // named arguments
RSVP("Noor", 4, inviteOnly: false); // named arguments
...
{
    string email = $"{firstName.ToLower().Substring(0, 2)}{lastName.ToLower()}@{domain}";
